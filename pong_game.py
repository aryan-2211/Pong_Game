...
def draw(canvas):
    ...
    canvas.draw_polygon([[WIDTH, paddle2_pos], [WIDTH - PAD_WIDTH, paddle2_pos], [WIDTH - PAD_WIDTH, paddle2_pos + PAD_WIDTH], [WIDTH, paddle2_pos + PAD_HEIGHT]],1, "green", "green")
    
    # determine whether paddle and ball collide    
    
    # draw scores
    canvas.draw_text(str(score1), [230, 100], 50, "green")    
    canvas.draw_text(str(score2), [350, 100], 50, "green")
